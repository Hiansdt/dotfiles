...
const totalServices =  computed(() =>
  sessionPaymentController.sessionPayments.filter((sessionPayment) => sessionPayment.session_completed).reduce(
    (a, b) => a + Number(b.price),
    0,
  ),
);
  ...
  <VCard class="my-4">
    ...
    <VCardText class="my-6">
      <VRow class="d-flex justify-space-between align-center px-3">
        <div>
          <h4 class="text-body-1">Total em Serviços Realizados</h4>
        </div>
      ...
      <VRow class="d-flex justify-space-between align-center px-3">
        <div>
          <h4 class="text-body-1">Lucro em Serviços Pagos</h4>
        </div>
