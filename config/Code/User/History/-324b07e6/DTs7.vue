...
const edit = async (data: any) => {
  try {
    ...
    const index = serviceController.services.findIndex(
...
<template>
  <VDialog
    ...
    :width="600"
    :min-width="props.minWidth ?? '600'"
  >
    <VCard class="position-relative">
      <VCard
        v-if="props.loading"
        class="d-flex align-center justify-center h-100 w-100 position-absolute top-0 left-0 bg-surface"
        style="z-index: 2"
      >
