      ...
      },
      {
        ...
        function()
          require('fzf-lua').live_grep_native({
            rg_opts = "--hidden --glob '!.git/*' --glob '!node_modules/*'",
          })
        end,
        desc = 'Grep'
      },
  ...
  },
  {
    ...
    opts = function()
      ...
      vim.keymap.set("n", "gd", function()
        fzf.lsp_definitions({ jump1 = true, silent = true, ignore_current_line = true })
      end, { desc = "Goto Definition" })

      vim.keymap.set("n", "gr", function()
        fzf.lsp_references({ jump1 = true, silent = true, ignore_current_line = true })
      end, { desc = "References", nowait = true })

      vim.keymap.set("n", "gI", function()
        fzf.lsp_implementations({ jump1 = true, silent = true, ignore_current_line = true })
      end, { desc = "Goto Implementation" })

      vim.keymap.set("n", "gy", function()
        fzf.lsp_typedefs({ jump1 = true, silent = true, ignore_current_line = true })
