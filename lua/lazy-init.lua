...
require('lazy').setup({
  spec = {
    ...
    { import = 'plugins.editor.comfy-line-numbers' },
    { import = 'plugins.editor.harpoon' },
    { import = 'plugins.editor.terminal' },
    { import = 'plugins.editor.recent-files' },
    ...
    { import = 'plugins.languages.django' },
    ...
    { import = 'plugins.util.project' },
    { import = 'plugins.util.alpha' },
    { import = 'plugins.coding.dev-container' },
