...
import ListServicesPaid from "@/cashier/infra/components/cash/ListServicesPaid.vue";
import ExtractTotals from "@/cashier/infra/components/cash/ExtractTotals.vue";
...
import EntrancesDepartures from "@/cashier/infra/components/cash/check/EntrancesDepartures.vue";
...
const tabs = [
  ...
  { icon: "ri-login-box-line", title: "Movimentações Manuais" },
];
  ...
  <div class="d-flex flex-column ga-4">
    ...
    <VRow>
      <VCol cols="6">
        ...
        <h2 class="text-h6 text-medium-emphasis">{{ cash?.employee_name }}</h2>
      </VCol>
    ...
    <VRow class="pa-2 mt-2" col="12" v-if="showCloseCashBtn">
      <VCol col="12">
        <VBtn
          block
          variant="flat"
